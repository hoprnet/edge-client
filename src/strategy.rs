...
pub use hopr_strategy::{strategy::MultiStrategyConfig, Strategy, auto_funding::AutoFundingStrategyConfig, channel_finalizer::ClosureFinalizerStrategyConfig};
...
pub fn default_edge_client_telemetry_reactor_cfg(min_channel_balance: HoprBalance, top_up_amount: HoprBalance) -> MultiStrategyConfig {
    MultiStrategyConfig {
